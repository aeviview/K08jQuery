...
public class NaverSearchAPI extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		String clientId = "QS862TfCl5jaxXPWh6U9"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "VE8cinCdIb"; //애플리케이션 클라이언트 시크릿값"
        ...
        try 
        {
        	...
        	text = URLEncoder.encode(searchTxt, "UTF-8"); //검색어 입력!
        } 
        ...
        System.out.println(responseBody); //결과물이 출력되는 부분
