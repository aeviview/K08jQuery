...
//zipcode테이블에서  sido를 중복 제거하여 가져온다!
		...
		$.ajax(
		{
			...
			success:function(d)
			{
				...
				/*
				   ...
				   ["중랑구","중구","종로구","은평구","용산구","영등포구","양천구",
					"송파구","성북구","성동구","서초구","서대문구","마포구","동작구",
		            "동대문구","도봉구","노원구","금천구","구로구","광진구","관악구",
		            "강서구","강북구","강동구","강남구"]
				*/
				var optionStr = "";
